...
export default function ArticleErrorPage() {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] px-4">
        <div className="bg-gray-900 border border-red-200 rounded-lg p-8 shadow-md max-w-md w-full">
            <h1 className="text-2xl font-bold text-white mb-2">Article Not Loaded</h1>
